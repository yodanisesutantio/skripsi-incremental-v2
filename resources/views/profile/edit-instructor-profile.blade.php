        ...
        <div class="flex flex-col mt-4 gap-5 lg:gap-7">
            ...
            <div class="flex flex-col gap-2">
                ...
                @if (auth()->user()->hash_for_profile_picture)
                    <img src="{{ asset('storage/profile_pictures/' . auth()->user()->hash_for_profile_picture) }}" alt="profile-picture" class="w-20 lg:w-32 h-20 lg:h-32 mb-2 rounded-full">
                @endif
            ...
            <div class="flex flex-col gap-1">
                <label for="fullname" class="font-semibold font-league text-xl text-custom-grey">Nama Lengkap Instruktur<span class="text-custom-destructive">*</span></label>
